...
SELECT
    ...
    -- Avg selling price (safe division)
...
SELECT 
    ...
    -- Recency in months (PostgreSQL)
    DATE_PART('month', AGE(CURRENT_DATE, last_sale_date)) 
    + 12 * DATE_PART('year', AGE(CURRENT_DATE, last_sale_date)) AS recency_in_months,
